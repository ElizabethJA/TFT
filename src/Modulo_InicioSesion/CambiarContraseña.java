...
public class CambiarContraseña extends javax.swing.JDialog {
    private transient ResultSet infoAdmin;
    private String nombreUsuario;
    private transient Connection conexion;
    private static final int LONGNOMBRE = 15;
    private static final int LONGCONTRASENA = 10;
    private static final String DIR = "/Imagenes/eliminar.png";
    private static final String TAHOMA = "Tahoma";
    private JFrame ventanaUsuario;
    private JFrame ventanaPadreDeUsuario;
    /**
    ...
    private void initComponents() {
        javax.swing.JButton guardar_cambios;
        ...
        check_cambio_nombre.addItemListener(this::check_cambio_nombreItemStateChanged);
    ...
    private void check_cambio_nombreItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_check_cambio_nombreItemStateChanged
        ...
        etiqueta_resultado_usuario.setIcon(seleccionado ? new javax.swing.ImageIcon(getClass().getResource(DIR)) : null);
   ...
   /**
    ...
    private void contraseña_actualKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_contraseña_actualKeyTyped
        if (contraseña_actual.getPassword().length == LONGCONTRASENA)
            evt.consume();
    ...
    private void contraseña_nuevaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_contraseña_nuevaKeyTyped
        if (contraseña_nueva.getPassword().length == LONGCONTRASENA)
            evt.consume();
    ...
    private void contraseña_confirmacionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_contraseña_confirmacionKeyTyped
        if (contraseña_confirmacion.getPassword().length == LONGCONTRASENA)
            evt.consume();
    ...
    private void nuevo_nombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nuevo_nombreKeyReleased
        etiqueta_resultado_usuario.setIcon((nuevo_nombre.getText().length()==0) ?
                new javax.swing.ImageIcon(getClass().getResource(DIR)) : null);
    ...
    private void contraseña_nuevaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_contraseña_nuevaKeyReleased
        etiqueta_resultado_contraseñaNueva.setIcon(contraseña_nueva.getPassword().length == 0 ?
                new javax.swing.ImageIcon(getClass().getResource(DIR)) : null);
        int longContraseñaN = contraseña_nueva.getPassword().length;
        int longConfirmacion = contraseña_confirmacion.getPassword().length;
        if (longConfirmacion < longContraseñaN)
            ...
            etiqueta_resultado_confirmacion.setIcon(new javax.swing.ImageIcon(getClass().getResource(DIR)));
    ...
    private boolean comparar_contraseñas() {
        char[] contraseña = contraseña_nueva.getPassword();
        char[] confirmacion = contraseña_confirmacion.getPassword();
